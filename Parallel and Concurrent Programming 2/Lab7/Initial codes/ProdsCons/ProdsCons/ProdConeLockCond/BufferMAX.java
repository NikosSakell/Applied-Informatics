...
//1.1 β) για κλειδώματα και μεταβλητές συνθήκης με άπειρο μέγεθος buffer

public class BufferMAX
{
	...
	//Δεν χρειάζεται condition για να κάνουμε notify για full buffer
	//αφού θεωρητικά δεν γίνεται να γεμίσει
	// private Condition bufferFull = lock.newCondition();
	private Condition bufferEmpty = lock.newCondition();

	// Constructor
	public BufferMAX(int s) {
	// this.size = s;
