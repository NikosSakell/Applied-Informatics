...
public class FindPiMutex {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i<numThreads; i++){
            ...
            threads[i] = new PiThread(sums, i, start, stop, step, lock);
            threads[i].start();
        }
...
class PiThread extends Thread{
    ...
    public PiThread(double[] sums, int index, long start, long stop, double step, Lock lock){
        this.index = index;
        this.sums=sums;
        this.lock = lock;
        this.start = start;
...
//200000 steps
//computed pi = 3,14159265359187940000
//difference between estimated pi and Math.PI = 0,00000000000208633111
//time to compute = 0,006000 second